...
def from_pretrained(
    ...
    **model_args
    ...
    Args:
        ...
        revision (str): Revision at that repo.
        model_type (str): If specified, overrides the assumed model type.
        **model_args: Keyword arguments to overwrite defaults in model args.
